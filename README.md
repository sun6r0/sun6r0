...
- Менторство как хобби - отменторила по теории тестирования и тестированию API более 40 стажеров, помогла вкатиться из QA в AQA 3 коллегам на коммерческом проекте и консультировала по первым неделям на проекте более 17 человек
